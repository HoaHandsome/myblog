...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin_show_dashboard')}}">
                ...
                <div class="sidebar-brand-text mx-3">John (Hòa) <sup><i class="fas fa-medal"></i></sup></div>
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseTwo1" aria-expanded="true"
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manager Experience:</h6>
                        <a class="collapse-item" href="buttons.html">Education</a>
                        <a class="collapse-item" href="cards.html">Job</a>
                    </div>
                </div>
            </li>
            <li class="nav-item active">
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manager Introduct:</h6>
                        <a class="collapse-item" href="buttons.html">About me</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; www.levanhoa.com 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
